...
on its own settings, theme, process, evolved concept, and updated bootstrap packages, distinct from stock UserLAnd (this is essentially what Sovereign-ULA is to UserLAnd — *rebased and reimagined*).
